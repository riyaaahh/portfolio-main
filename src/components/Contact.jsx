...
const Contact = () => {
  return (
    <div className="bg-green-200">
      ...
      <section className="bg-green-200" id="contact">
        <div className="bg-green-200 h-full">
        <div className="mx-auto max-w-7xl px-4 border border-black bg-white my-8  py-16 sm:px-6 lg:px-8 lg:py-20">
          <div className="mb-4">
            ...
            <div className="grid md:grid-cols-2">
              <div className="h-full pr-6">
                <p className="mt-3 mb-12 text-lg text-black ">
                  If you prefer a face-to-face conversation, we'd love to
                  welcome you at our office. Here's our address:
                </p>
      ...
      <footer className="bg-black text-white p-5 text-center">
        <div className="container mx-auto">
          <p>&copy; 2024 PortFOe. All Rights Reserved.</p>
        </div>
      </footer>
      </div>
  );
